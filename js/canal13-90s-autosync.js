...
(function () {
  ...
  var DATA_URL = 'data.json?v=20260803-canal13-1';
  ...
  var SELECTORS = {
    grid: '#canal13-90s-grid',
    featuredSlider: '#canal13-featured-slider',
    yearFilters: '[data-canal13-year]',
    categoryFilters: '[data-canal13-category]',
    title: '#canal13-catalogue-title',
    description: '#canal13-catalogue-description',
    empty: '#canal13-empty-state',
  ...
  function belongsToCanal13(item) {
  ...
  function buildCard(item) {
    ...
    if (safeSubtitle) {
      subtitleHtml =
        '<span class="canal13-card-subtitle">' +
          safeSubtitle +
        '</span>';
    }
    ...
    return [
      ...
      '>',
        ...
        '<a',
          ' class="canal13-card-link"',
          ' href="', safeHref, '"',
          ' aria-label="Ver ficha de ', safeTitle, '"',
        '>',

          '<div class="canal13-card-image">',
          ...
          '<div class="canal13-card-text">',

            '<strong class="canal13-card-title">',
              safeTitle,
            '</strong>',

            '<span class="canal13-card-year">',
              safeYear,
            '</span>',
    ...
    .catch(function (error) {
      ...
      if (grid) {
        ...
        grid.innerHTML =
          ...
          'No fue posible cargar el catálogo de Canal 13.' +
          '</p>';
