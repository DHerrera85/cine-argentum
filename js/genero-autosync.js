(function () {
  ...
  var COMEDIA_TITLES = [
    ...
    'Papá por Dos', 'Las Hermanas Fantásticas', 'No Me Rompan', 'Granizo', 'Casi leyendas', 'Sin hijos', 'Peter Capusoto y sus 3 dimensiones', 'Días de vinilo', 'Un cuento chino', 'Un Novio para mi Mujer', 'Los Super Agentes: La Nueva Generación', 'Bañeros 3, todopoderosos', 'Cohen vs Rosi', 'La Noche Mágica', 'Doble Discurso'
  ];
